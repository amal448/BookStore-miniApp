...
const OrderPage = () => {
    ...
    const { data: ordersResponse = {}, isLoading, isError } = useGetOrdersByEmailQuery(currentUser.email)
    const orders = ordersResponse.data || [] // Extract orders from ordersResponse or use an empty array
